...
public class GoogleApiUtil {
	...
	public  void getSpreadSheetData(List<String> idsList) throws IOException, GeneralSecurityException {
		for (String id : idsList) {
			final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
			// final String spreadsheetId = "1QNAE6eympfNkC4KsQ7oU68Dya5fqpQnS5RUuPafePAg";
			final String spreadsheetId = id;
			final String range = "A1:F93";
			...
			if (values == null || values.isEmpty()) {
				...
				excelReadingService.insertDataInDb(values,id);
			}
		}
	}
